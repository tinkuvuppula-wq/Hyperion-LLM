/**
 * InstructionPrunerBytePairQuantizerCompressor.js - Prompt Context Compression: InstructionPruner -> BytePairQuantizer.
 */

class InstructionPrunerBytePairQuantizerCompressor {
...
module.exports = { InstructionPrunerBytePairQuantizerCompressor };
