/**
 * SystemPromptEmbeddingPrunerZeroLossTokenStripperCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> ZeroLossTokenStripper.
 */

class SystemPromptEmbeddingPrunerZeroLossTokenStripperCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'ZeroLossTokenStripper';
...
module.exports = { SystemPromptEmbeddingPrunerZeroLossTokenStripperCompressor };
