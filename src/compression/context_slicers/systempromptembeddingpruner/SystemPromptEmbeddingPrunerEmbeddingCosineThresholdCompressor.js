/**
 * SystemPromptEmbeddingPrunerEmbeddingCosineThresholdCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> EmbeddingCosineThreshold.
 */

class SystemPromptEmbeddingPrunerEmbeddingCosineThresholdCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'EmbeddingCosineThreshold';
...
module.exports = { SystemPromptEmbeddingPrunerEmbeddingCosineThresholdCompressor };
