/**
 * SystemPromptEmbeddingPrunerDynamicBudgetSlicerCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> DynamicBudgetSlicer.
 */

class SystemPromptEmbeddingPrunerDynamicBudgetSlicerCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'DynamicBudgetSlicer';
...
module.exports = { SystemPromptEmbeddingPrunerDynamicBudgetSlicerCompressor };
