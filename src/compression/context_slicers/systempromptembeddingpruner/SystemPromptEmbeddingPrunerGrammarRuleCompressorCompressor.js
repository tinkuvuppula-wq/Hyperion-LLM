/**
 * SystemPromptEmbeddingPrunerGrammarRuleCompressorCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> GrammarRuleCompressor.
 */

class SystemPromptEmbeddingPrunerGrammarRuleCompressorCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'GrammarRuleCompressor';
...
module.exports = { SystemPromptEmbeddingPrunerGrammarRuleCompressorCompressor };
