/**
 * SystemPromptEmbeddingPrunerASTNodeWeightFilterCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> ASTNodeWeightFilter.
 */

class SystemPromptEmbeddingPrunerASTNodeWeightFilterCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'ASTNodeWeightFilter';
...
module.exports = { SystemPromptEmbeddingPrunerASTNodeWeightFilterCompressor };
