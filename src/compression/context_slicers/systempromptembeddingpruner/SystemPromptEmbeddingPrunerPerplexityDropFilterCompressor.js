/**
 * SystemPromptEmbeddingPrunerPerplexityDropFilterCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> PerplexityDropFilter.
 */

class SystemPromptEmbeddingPrunerPerplexityDropFilterCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'PerplexityDropFilter';
...
module.exports = { SystemPromptEmbeddingPrunerPerplexityDropFilterCompressor };
