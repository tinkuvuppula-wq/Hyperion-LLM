/**
 * SystemPromptEmbeddingPrunerSemanticSimilarityDeduplicatorCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> SemanticSimilarityDeduplicator.
 */

class SystemPromptEmbeddingPrunerSemanticSimilarityDeduplicatorCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'SemanticSimilarityDeduplicator';
    this.compressionRatioTarget = 0.53;
...
module.exports = { SystemPromptEmbeddingPrunerSemanticSimilarityDeduplicatorCompressor };
