/**
 * SystemPromptEmbeddingPrunerBytePairQuantizerCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> BytePairQuantizer.
 */

class SystemPromptEmbeddingPrunerBytePairQuantizerCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'BytePairQuantizer';
...
module.exports = { SystemPromptEmbeddingPrunerBytePairQuantizerCompressor };
