/**
 * SystemPromptEmbeddingPrunerTopPInformationFilterCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> TopPInformationFilter.
 */

class SystemPromptEmbeddingPrunerTopPInformationFilterCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'TopPInformationFilter';
...
module.exports = { SystemPromptEmbeddingPrunerTopPInformationFilterCompressor };
