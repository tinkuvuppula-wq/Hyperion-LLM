/**
 * SystemPromptEmbeddingPrunerAttentionWeightFilterCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> AttentionWeightFilter.
 */

class SystemPromptEmbeddingPrunerAttentionWeightFilterCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'AttentionWeightFilter';
...
module.exports = { SystemPromptEmbeddingPrunerAttentionWeightFilterCompressor };
