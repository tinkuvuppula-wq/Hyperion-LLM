/**
 * SystemPromptEmbeddingPrunerTFIDFInformationGainCompressor.js - Prompt Context Compression: SystemPromptEmbeddingPruner -> TFIDFInformationGain.
 */

class SystemPromptEmbeddingPrunerTFIDFInformationGainCompressor {
  constructor(compConfig = {}) {
    this.domain = 'SystemPromptEmbeddingPruner';
    this.filterType = 'TFIDFInformationGain';
...
module.exports = { SystemPromptEmbeddingPrunerTFIDFInformationGainCompressor };
