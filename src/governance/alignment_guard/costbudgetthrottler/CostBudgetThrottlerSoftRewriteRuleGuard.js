/**
 * CostBudgetThrottlerSoftRewriteRuleGuard.js - Enterprise LLM Governance & Alignment: CostBudgetThrottler -> SoftRewriteRule.
 */

class CostBudgetThrottlerSoftRewriteRuleGuard {
...
module.exports = { CostBudgetThrottlerSoftRewriteRuleGuard };
