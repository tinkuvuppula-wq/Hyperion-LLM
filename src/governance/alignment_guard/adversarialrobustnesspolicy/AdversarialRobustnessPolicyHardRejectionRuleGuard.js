/**
 * AdversarialRobustnessPolicyHardRejectionRuleGuard.js - Enterprise LLM Governance & Alignment: AdversarialRobustnessPolicy -> HardRejectionRule.
 */

class AdversarialRobustnessPolicyHardRejectionRuleGuard {
  constructor(govConfig = {}) {
    this.framework = 'AdversarialRobustnessPolicy';
    this.enforcementRule = 'HardRejectionRule';
...
module.exports = { AdversarialRobustnessPolicyHardRejectionRuleGuard };
