/**
 * CodeGenerationExpertNoisyTop2RouterRouter.js - Mixture-of-Experts Router: CodeGenerationExpert -> NoisyTop2Router.
 */

class CodeGenerationExpertNoisyTop2RouterRouter {
  constructor(config = {}) {
...
module.exports = { CodeGenerationExpertNoisyTop2RouterRouter };
