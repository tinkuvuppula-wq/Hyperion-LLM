/**
 * ConversationalPersonaExpertExpertChoiceRoutingRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> ExpertChoiceRouting.
 */

class ConversationalPersonaExpertExpertChoiceRoutingRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'ExpertChoiceRouting';
    this.numExperts = 24;
    this.topK = 4;
...
module.exports = { ConversationalPersonaExpertExpertChoiceRoutingRouter };
