/**
 * ConversationalPersonaExpertEntropyGuidedRouterRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> EntropyGuidedRouter.
 */

class ConversationalPersonaExpertEntropyGuidedRouterRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'EntropyGuidedRouter';
    this.numExperts = 24;
    this.topK = 2;
...
module.exports = { ConversationalPersonaExpertEntropyGuidedRouterRouter };
