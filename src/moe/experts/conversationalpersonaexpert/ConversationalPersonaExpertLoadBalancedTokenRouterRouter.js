/**
 * ConversationalPersonaExpertLoadBalancedTokenRouterRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> LoadBalancedTokenRouter.
 */

class ConversationalPersonaExpertLoadBalancedTokenRouterRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'LoadBalancedTokenRouter';
    this.numExperts = 24;
    this.topK = 3;
...
module.exports = { ConversationalPersonaExpertLoadBalancedTokenRouterRouter };
