/**
 * ConversationalPersonaExpertSinkhornKnoppRouterRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> SinkhornKnoppRouter.
 */

class ConversationalPersonaExpertSinkhornKnoppRouterRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'SinkhornKnoppRouter';
    this.numExperts = 24;
    this.topK = 4;
...
module.exports = { ConversationalPersonaExpertSinkhornKnoppRouterRouter };
