/**
 * ConversationalPersonaExpertCapacityFactorGuardRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> CapacityFactorGuard.
 */

class ConversationalPersonaExpertCapacityFactorGuardRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'CapacityFactorGuard';
    this.numExperts = 24;
    this.topK = 4;
...
module.exports = { ConversationalPersonaExpertCapacityFactorGuardRouter };
