/**
 * ConversationalPersonaExpertCrossDomainRouterRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> CrossDomainRouter.
 */

class ConversationalPersonaExpertCrossDomainRouterRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'CrossDomainRouter';
    this.numExperts = 24;
    this.topK = 2;
...
module.exports = { ConversationalPersonaExpertCrossDomainRouterRouter };
