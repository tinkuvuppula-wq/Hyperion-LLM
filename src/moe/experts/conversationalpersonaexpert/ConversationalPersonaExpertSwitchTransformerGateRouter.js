/**
 * ConversationalPersonaExpertSwitchTransformerGateRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> SwitchTransformerGate.
 */

class ConversationalPersonaExpertSwitchTransformerGateRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'SwitchTransformerGate';
    this.numExperts = 24;
    this.topK = 3;
...
module.exports = { ConversationalPersonaExpertSwitchTransformerGateRouter };
