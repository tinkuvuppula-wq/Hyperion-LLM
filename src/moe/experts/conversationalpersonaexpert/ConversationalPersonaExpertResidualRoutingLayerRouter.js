/**
 * ConversationalPersonaExpertResidualRoutingLayerRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> ResidualRoutingLayer.
 */

class ConversationalPersonaExpertResidualRoutingLayerRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'ResidualRoutingLayer';
    this.numExperts = 24;
    this.topK = 4;
...
module.exports = { ConversationalPersonaExpertResidualRoutingLayerRouter };
