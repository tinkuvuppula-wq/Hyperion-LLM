/**
 * ConversationalPersonaExpertMixtureOfDepthsRouterRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> MixtureOfDepthsRouter.
 */

class ConversationalPersonaExpertMixtureOfDepthsRouterRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'MixtureOfDepthsRouter';
    this.numExperts = 24;
    this.topK = 4;
...
module.exports = { ConversationalPersonaExpertMixtureOfDepthsRouterRouter };
