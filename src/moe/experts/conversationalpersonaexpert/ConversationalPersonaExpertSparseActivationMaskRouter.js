/**
 * ConversationalPersonaExpertSparseActivationMaskRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> SparseActivationMask.
 */

class ConversationalPersonaExpertSparseActivationMaskRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'SparseActivationMask';
    this.numExperts = 24;
    this.topK = 2;
...
module.exports = { ConversationalPersonaExpertSparseActivationMaskRouter };
