/**
 * ConversationalPersonaExpertHierarchicalMoERouterRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> HierarchicalMoERouter.
 */

class ConversationalPersonaExpertHierarchicalMoERouterRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'HierarchicalMoERouter';
    this.numExperts = 24;
    this.topK = 2;
...
module.exports = { ConversationalPersonaExpertHierarchicalMoERouterRouter };
