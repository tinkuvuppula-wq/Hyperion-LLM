/**
 * ConversationalPersonaExpertClusterCentroidRouterRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> ClusterCentroidRouter.
 */

class ConversationalPersonaExpertClusterCentroidRouterRouter {
  constructor(config = {}) {
    this.domain = 'ConversationalPersonaExpert';
    this.routerStrategy = 'ClusterCentroidRouter';
    this.numExperts = 24;
    this.topK = 2;
...
module.exports = { ConversationalPersonaExpertClusterCentroidRouterRouter };
