/**
 * ConversationalPersonaExpertNoisyTop2RouterRouter.js - Mixture-of-Experts Router: ConversationalPersonaExpert -> NoisyTop2Router.
 */

class ConversationalPersonaExpertNoisyTop2RouterRouter {
  constructor(config = {}) {
...
module.exports = { ConversationalPersonaExpertNoisyTop2RouterRouter };
