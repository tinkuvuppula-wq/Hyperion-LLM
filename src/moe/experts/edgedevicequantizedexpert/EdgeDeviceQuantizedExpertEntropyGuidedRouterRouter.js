/**
 * EdgeDeviceQuantizedExpertEntropyGuidedRouterRouter.js - Mixture-of-Experts Router: EdgeDeviceQuantizedExpert -> EntropyGuidedRouter.
 */

class EdgeDeviceQuantizedExpertEntropyGuidedRouterRouter {
  constructor(config = {}) {
...
module.exports = { EdgeDeviceQuantizedExpertEntropyGuidedRouterRouter };
