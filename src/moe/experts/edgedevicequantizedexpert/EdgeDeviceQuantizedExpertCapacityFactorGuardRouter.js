/**
 * EdgeDeviceQuantizedExpertCapacityFactorGuardRouter.js - Mixture-of-Experts Router: EdgeDeviceQuantizedExpert -> CapacityFactorGuard.
 */

class EdgeDeviceQuantizedExpertCapacityFactorGuardRouter {
  constructor(config = {}) {
...
module.exports = { EdgeDeviceQuantizedExpertCapacityFactorGuardRouter };
