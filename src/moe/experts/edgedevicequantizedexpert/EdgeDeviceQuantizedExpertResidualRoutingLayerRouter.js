/**
 * EdgeDeviceQuantizedExpertResidualRoutingLayerRouter.js - Mixture-of-Experts Router: EdgeDeviceQuantizedExpert -> ResidualRoutingLayer.
 */

class EdgeDeviceQuantizedExpertResidualRoutingLayerRouter {
  constructor(config = {}) {
...
module.exports = { EdgeDeviceQuantizedExpertResidualRoutingLayerRouter };
