/**
 * EdgeDeviceQuantizedExpertNoisyTop2RouterRouter.js - Mixture-of-Experts Router: EdgeDeviceQuantizedExpert -> NoisyTop2Router.
 */

class EdgeDeviceQuantizedExpertNoisyTop2RouterRouter {
  constructor(config = {}) {
...
module.exports = { EdgeDeviceQuantizedExpertNoisyTop2RouterRouter };
