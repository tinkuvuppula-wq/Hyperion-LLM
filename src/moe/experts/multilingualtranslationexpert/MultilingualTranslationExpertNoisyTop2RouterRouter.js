/**
 * MultilingualTranslationExpertNoisyTop2RouterRouter.js - Mixture-of-Experts Router: MultilingualTranslationExpert -> NoisyTop2Router.
 */

class MultilingualTranslationExpertNoisyTop2RouterRouter {
  constructor(config = {}) {
...
module.exports = { MultilingualTranslationExpertNoisyTop2RouterRouter };
