/**
 * HQQHalfQuadraticQuantizerCUDASpeculativeDraftKernelKernel.js - Hardware Acceleration & Quantization Kernel: HQQHalfQuadraticQuantizer -> CUDASpeculativeDraftKernel.
 */

class HQQHalfQuadraticQuantizerCUDASpeculativeDraftKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'HQQHalfQuadraticQuantizer';
...
module.exports = { HQQHalfQuadraticQuantizerCUDASpeculativeDraftKernelKernel };
