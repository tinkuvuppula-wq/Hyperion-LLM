/**
 * GPTQActivationQuantizerONNXRuntimeInferenceKernelKernel.js - Hardware Acceleration & Quantization Kernel: GPTQActivationQuantizer -> ONNXRuntimeInferenceKernel.
 */

class GPTQActivationQuantizerONNXRuntimeInferenceKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'GPTQActivationQuantizer';
...
module.exports = { GPTQActivationQuantizerONNXRuntimeInferenceKernelKernel };
