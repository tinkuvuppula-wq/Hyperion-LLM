/**
 * SpQRWeightOutlierQuantizerXLAJitFusedKernelKernel.js - Hardware Acceleration & Quantization Kernel: SpQRWeightOutlierQuantizer -> XLAJitFusedKernel.
 */

class SpQRWeightOutlierQuantizerXLAJitFusedKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SpQRWeightOutlierQuantizer';
    this.kernelType = 'XLAJitFusedKernel';
    this.quantBits = 6;
...
module.exports = { SpQRWeightOutlierQuantizerXLAJitFusedKernelKernel };
