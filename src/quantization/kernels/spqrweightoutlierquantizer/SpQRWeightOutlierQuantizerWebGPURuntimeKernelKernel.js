/**
 * SpQRWeightOutlierQuantizerWebGPURuntimeKernelKernel.js - Hardware Acceleration & Quantization Kernel: SpQRWeightOutlierQuantizer -> WebGPURuntimeKernel.
 */

class SpQRWeightOutlierQuantizerWebGPURuntimeKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SpQRWeightOutlierQuantizer';
    this.kernelType = 'WebGPURuntimeKernel';
    this.quantBits = 6;
...
module.exports = { SpQRWeightOutlierQuantizerWebGPURuntimeKernelKernel };
