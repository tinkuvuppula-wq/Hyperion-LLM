/**
 * SpQRWeightOutlierQuantizerVulkanMobileEngineKernel.js - Hardware Acceleration & Quantization Kernel: SpQRWeightOutlierQuantizer -> VulkanMobileEngine.
 */

class SpQRWeightOutlierQuantizerVulkanMobileEngineKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SpQRWeightOutlierQuantizer';
    this.kernelType = 'VulkanMobileEngine';
    this.quantBits = 6;
...
module.exports = { SpQRWeightOutlierQuantizerVulkanMobileEngineKernel };
