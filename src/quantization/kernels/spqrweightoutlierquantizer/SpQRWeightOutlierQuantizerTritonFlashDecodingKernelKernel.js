/**
 * SpQRWeightOutlierQuantizerTritonFlashDecodingKernelKernel.js - Hardware Acceleration & Quantization Kernel: SpQRWeightOutlierQuantizer -> TritonFlashDecodingKernel.
 */

class SpQRWeightOutlierQuantizerTritonFlashDecodingKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SpQRWeightOutlierQuantizer';
    this.kernelType = 'TritonFlashDecodingKernel';
    this.quantBits = 6;
...
module.exports = { SpQRWeightOutlierQuantizerTritonFlashDecodingKernelKernel };
