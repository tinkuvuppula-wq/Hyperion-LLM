/**
 * SpQRWeightOutlierQuantizerAVX512SIMDEngineKernel.js - Hardware Acceleration & Quantization Kernel: SpQRWeightOutlierQuantizer -> AVX512SIMDEngine.
 */

class SpQRWeightOutlierQuantizerAVX512SIMDEngineKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SpQRWeightOutlierQuantizer';
    this.kernelType = 'AVX512SIMDEngine';
    this.quantBits = 6;
...
module.exports = { SpQRWeightOutlierQuantizerAVX512SIMDEngineKernel };
