/**
 * SpQRWeightOutlierQuantizerONNXRuntimeInferenceKernelKernel.js - Hardware Acceleration & Quantization Kernel: SpQRWeightOutlierQuantizer -> ONNXRuntimeInferenceKernel.
 */

class SpQRWeightOutlierQuantizerONNXRuntimeInferenceKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SpQRWeightOutlierQuantizer';
    this.kernelType = 'ONNXRuntimeInferenceKernel';
    this.quantBits = 6;
...
module.exports = { SpQRWeightOutlierQuantizerONNXRuntimeInferenceKernelKernel };
