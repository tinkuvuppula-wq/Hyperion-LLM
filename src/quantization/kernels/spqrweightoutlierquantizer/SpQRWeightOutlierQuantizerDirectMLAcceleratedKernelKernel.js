/**
 * SpQRWeightOutlierQuantizerDirectMLAcceleratedKernelKernel.js - Hardware Acceleration & Quantization Kernel: SpQRWeightOutlierQuantizer -> DirectMLAcceleratedKernel.
 */

class SpQRWeightOutlierQuantizerDirectMLAcceleratedKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SpQRWeightOutlierQuantizer';
    this.kernelType = 'DirectMLAcceleratedKernel';
    this.quantBits = 6;
...
module.exports = { SpQRWeightOutlierQuantizerDirectMLAcceleratedKernelKernel };
