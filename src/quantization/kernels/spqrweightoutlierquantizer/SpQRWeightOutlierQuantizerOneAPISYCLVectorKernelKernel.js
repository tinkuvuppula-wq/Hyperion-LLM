/**
 * SpQRWeightOutlierQuantizerOneAPISYCLVectorKernelKernel.js - Hardware Acceleration & Quantization Kernel: SpQRWeightOutlierQuantizer -> OneAPISYCLVectorKernel.
 */

class SpQRWeightOutlierQuantizerOneAPISYCLVectorKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SpQRWeightOutlierQuantizer';
    this.kernelType = 'OneAPISYCLVectorKernel';
    this.quantBits = 6;
...
module.exports = { SpQRWeightOutlierQuantizerOneAPISYCLVectorKernelKernel };
