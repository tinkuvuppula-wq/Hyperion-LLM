/**
 * SpQRWeightOutlierQuantizerCUDASpeculativeDraftKernelKernel.js - Hardware Acceleration & Quantization Kernel: SpQRWeightOutlierQuantizer -> CUDASpeculativeDraftKernel.
 */

class SpQRWeightOutlierQuantizerCUDASpeculativeDraftKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SpQRWeightOutlierQuantizer';
    this.kernelType = 'CUDASpeculativeDraftKernel';
    this.quantBits = 6;
...
module.exports = { SpQRWeightOutlierQuantizerCUDASpeculativeDraftKernelKernel };
