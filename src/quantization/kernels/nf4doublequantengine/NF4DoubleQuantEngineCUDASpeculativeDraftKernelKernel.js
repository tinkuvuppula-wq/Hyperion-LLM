/**
 * NF4DoubleQuantEngineCUDASpeculativeDraftKernelKernel.js - Hardware Acceleration & Quantization Kernel: NF4DoubleQuantEngine -> CUDASpeculativeDraftKernel.
 */

class NF4DoubleQuantEngineCUDASpeculativeDraftKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'NF4DoubleQuantEngine';
...
module.exports = { NF4DoubleQuantEngineCUDASpeculativeDraftKernelKernel };
