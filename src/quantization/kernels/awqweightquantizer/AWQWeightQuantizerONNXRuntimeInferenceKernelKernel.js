/**
 * AWQWeightQuantizerONNXRuntimeInferenceKernelKernel.js - Hardware Acceleration & Quantization Kernel: AWQWeightQuantizer -> ONNXRuntimeInferenceKernel.
 */

class AWQWeightQuantizerONNXRuntimeInferenceKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'AWQWeightQuantizer';
...
module.exports = { AWQWeightQuantizerONNXRuntimeInferenceKernelKernel };
