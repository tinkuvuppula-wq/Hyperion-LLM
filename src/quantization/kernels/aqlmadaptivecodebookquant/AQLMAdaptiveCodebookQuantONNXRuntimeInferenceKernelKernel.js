/**
 * AQLMAdaptiveCodebookQuantONNXRuntimeInferenceKernelKernel.js - Hardware Acceleration & Quantization Kernel: AQLMAdaptiveCodebookQuant -> ONNXRuntimeInferenceKernel.
 */

class AQLMAdaptiveCodebookQuantONNXRuntimeInferenceKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'AQLMAdaptiveCodebookQuant';
...
module.exports = { AQLMAdaptiveCodebookQuantONNXRuntimeInferenceKernelKernel };
