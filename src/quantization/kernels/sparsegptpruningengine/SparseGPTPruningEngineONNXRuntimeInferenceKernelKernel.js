/**
 * SparseGPTPruningEngineONNXRuntimeInferenceKernelKernel.js - Hardware Acceleration & Quantization Kernel: SparseGPTPruningEngine -> ONNXRuntimeInferenceKernel.
 */

class SparseGPTPruningEngineONNXRuntimeInferenceKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SparseGPTPruningEngine';
...
module.exports = { SparseGPTPruningEngineONNXRuntimeInferenceKernelKernel };
