/**
 * OmniQuantVectorEngineONNXRuntimeInferenceKernelKernel.js - Hardware Acceleration & Quantization Kernel: OmniQuantVectorEngine -> ONNXRuntimeInferenceKernel.
 */

class OmniQuantVectorEngineONNXRuntimeInferenceKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'OmniQuantVectorEngine';
...
module.exports = { OmniQuantVectorEngineONNXRuntimeInferenceKernelKernel };
