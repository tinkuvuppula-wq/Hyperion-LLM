/**
 * QATFineTuneQuantizerCUDASpeculativeDraftKernelKernel.js - Hardware Acceleration & Quantization Kernel: QATFineTuneQuantizer -> CUDASpeculativeDraftKernel.
 */

class QATFineTuneQuantizerCUDASpeculativeDraftKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'QATFineTuneQuantizer';
...
module.exports = { QATFineTuneQuantizerCUDASpeculativeDraftKernelKernel };
