/**
 * SqueezeLLMClusteringQuantONNXRuntimeInferenceKernelKernel.js - Hardware Acceleration & Quantization Kernel: SqueezeLLMClusteringQuant -> ONNXRuntimeInferenceKernel.
 */

class SqueezeLLMClusteringQuantONNXRuntimeInferenceKernelKernel {
  constructor(kernelConfig = {}) {
    this.quantizer = 'SqueezeLLMClusteringQuant';
...
module.exports = { SqueezeLLMClusteringQuantONNXRuntimeInferenceKernelKernel };
