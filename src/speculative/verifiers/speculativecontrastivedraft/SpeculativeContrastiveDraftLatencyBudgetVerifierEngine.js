/**
 * SpeculativeContrastiveDraftLatencyBudgetVerifierEngine.js - Speculative Decoding Verifier: SpeculativeContrastiveDraft -> LatencyBudgetVerifier.
 */

class SpeculativeContrastiveDraftLatencyBudgetVerifierEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'SpeculativeContrastiveDraft';
    this.policy = 'LatencyBudgetVerifier';
...
module.exports = { SpeculativeContrastiveDraftLatencyBudgetVerifierEngine };
