/**
 * SpeculativeContrastiveDraftSpeculativeRollbackRecoveryEngine.js - Speculative Decoding Verifier: SpeculativeContrastiveDraft -> SpeculativeRollbackRecovery.
 */

class SpeculativeContrastiveDraftSpeculativeRollbackRecoveryEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'SpeculativeContrastiveDraft';
    this.policy = 'SpeculativeRollbackRecovery';
...
module.exports = { SpeculativeContrastiveDraftSpeculativeRollbackRecoveryEngine };
