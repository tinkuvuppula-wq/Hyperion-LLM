/**
 * SpeculativeContrastiveDraftEntropyThresholdVerifierEngine.js - Speculative Decoding Verifier: SpeculativeContrastiveDraft -> EntropyThresholdVerifier.
 */

class SpeculativeContrastiveDraftEntropyThresholdVerifierEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'SpeculativeContrastiveDraft';
    this.policy = 'EntropyThresholdVerifier';
...
module.exports = { SpeculativeContrastiveDraftEntropyThresholdVerifierEngine };
