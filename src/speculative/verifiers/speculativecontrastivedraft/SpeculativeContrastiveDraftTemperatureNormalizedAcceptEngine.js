/**
 * SpeculativeContrastiveDraftTemperatureNormalizedAcceptEngine.js - Speculative Decoding Verifier: SpeculativeContrastiveDraft -> TemperatureNormalizedAccept.
 */

class SpeculativeContrastiveDraftTemperatureNormalizedAcceptEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'SpeculativeContrastiveDraft';
    this.policy = 'TemperatureNormalizedAccept';
...
module.exports = { SpeculativeContrastiveDraftTemperatureNormalizedAcceptEngine };
