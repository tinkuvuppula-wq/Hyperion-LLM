/**
 * SpeculativeContrastiveDraftLossGuidedVerifierEngine.js - Speculative Decoding Verifier: SpeculativeContrastiveDraft -> LossGuidedVerifier.
 */

class SpeculativeContrastiveDraftLossGuidedVerifierEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'SpeculativeContrastiveDraft';
    this.policy = 'LossGuidedVerifier';
...
module.exports = { SpeculativeContrastiveDraftLossGuidedVerifierEngine };
