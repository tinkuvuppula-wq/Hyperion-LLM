/**
 * SpeculativeContrastiveDraftTopPProbabilityAcceptanceEngine.js - Speculative Decoding Verifier: SpeculativeContrastiveDraft -> TopPProbabilityAcceptance.
 */

class SpeculativeContrastiveDraftTopPProbabilityAcceptanceEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'SpeculativeContrastiveDraft';
    this.policy = 'TopPProbabilityAcceptance';
...
module.exports = { SpeculativeContrastiveDraftTopPProbabilityAcceptanceEngine };
