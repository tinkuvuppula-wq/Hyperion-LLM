/**
 * SpeculativeContrastiveDraftGreedyMatchVerifierEngine.js - Speculative Decoding Verifier: SpeculativeContrastiveDraft -> GreedyMatchVerifier.
 */

class SpeculativeContrastiveDraftGreedyMatchVerifierEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'SpeculativeContrastiveDraft';
    this.policy = 'GreedyMatchVerifier';
...
module.exports = { SpeculativeContrastiveDraftGreedyMatchVerifierEngine };
