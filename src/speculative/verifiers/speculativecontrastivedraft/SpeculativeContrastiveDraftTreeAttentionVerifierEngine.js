/**
 * SpeculativeContrastiveDraftTreeAttentionVerifierEngine.js - Speculative Decoding Verifier: SpeculativeContrastiveDraft -> TreeAttentionVerifier.
 */

class SpeculativeContrastiveDraftTreeAttentionVerifierEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'SpeculativeContrastiveDraft';
    this.policy = 'TreeAttentionVerifier';
...
module.exports = { SpeculativeContrastiveDraftTreeAttentionVerifierEngine };
