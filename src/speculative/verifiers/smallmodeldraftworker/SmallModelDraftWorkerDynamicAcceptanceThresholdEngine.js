/**
 * SmallModelDraftWorkerDynamicAcceptanceThresholdEngine.js - Speculative Decoding Verifier: SmallModelDraftWorker -> DynamicAcceptanceThreshold.
 */

class SmallModelDraftWorkerDynamicAcceptanceThresholdEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'SmallModelDraftWorker';
...
module.exports = { SmallModelDraftWorkerDynamicAcceptanceThresholdEngine };
