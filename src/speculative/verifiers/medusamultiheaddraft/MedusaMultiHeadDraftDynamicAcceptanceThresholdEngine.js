/**
 * MedusaMultiHeadDraftDynamicAcceptanceThresholdEngine.js - Speculative Decoding Verifier: MedusaMultiHeadDraft -> DynamicAcceptanceThreshold.
 */

class MedusaMultiHeadDraftDynamicAcceptanceThresholdEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'MedusaMultiHeadDraft';
...
module.exports = { MedusaMultiHeadDraftDynamicAcceptanceThresholdEngine };
