/**
 * EarlyExitDraftLatencyBudgetVerifierEngine.js - Speculative Decoding Verifier: EarlyExitDraft -> LatencyBudgetVerifier.
 */

class EarlyExitDraftLatencyBudgetVerifierEngine {
...
module.exports = { EarlyExitDraftLatencyBudgetVerifierEngine };
