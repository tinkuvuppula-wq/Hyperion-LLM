/**
 * EarlyExitDraftExactMatchVerifierEngine.js - Speculative Decoding Verifier: EarlyExitDraft -> ExactMatchVerifier.
 */

class EarlyExitDraftExactMatchVerifierEngine {
...
module.exports = { EarlyExitDraftExactMatchVerifierEngine };
