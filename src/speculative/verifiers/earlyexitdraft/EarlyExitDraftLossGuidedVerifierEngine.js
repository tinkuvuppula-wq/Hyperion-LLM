/**
 * EarlyExitDraftLossGuidedVerifierEngine.js - Speculative Decoding Verifier: EarlyExitDraft -> LossGuidedVerifier.
 */

class EarlyExitDraftLossGuidedVerifierEngine {
...
module.exports = { EarlyExitDraftLossGuidedVerifierEngine };
