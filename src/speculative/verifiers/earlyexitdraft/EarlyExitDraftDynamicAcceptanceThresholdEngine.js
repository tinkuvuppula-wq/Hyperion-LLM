/**
 * EarlyExitDraftDynamicAcceptanceThresholdEngine.js - Speculative Decoding Verifier: EarlyExitDraft -> DynamicAcceptanceThreshold.
 */

class EarlyExitDraftDynamicAcceptanceThresholdEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'EarlyExitDraft';
...
module.exports = { EarlyExitDraftDynamicAcceptanceThresholdEngine };
