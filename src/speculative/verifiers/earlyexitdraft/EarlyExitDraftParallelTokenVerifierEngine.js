/**
 * EarlyExitDraftParallelTokenVerifierEngine.js - Speculative Decoding Verifier: EarlyExitDraft -> ParallelTokenVerifier.
 */

class EarlyExitDraftParallelTokenVerifierEngine {
...
module.exports = { EarlyExitDraftParallelTokenVerifierEngine };
