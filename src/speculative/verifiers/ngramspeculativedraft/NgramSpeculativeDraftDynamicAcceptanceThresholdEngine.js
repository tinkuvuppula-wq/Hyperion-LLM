/**
 * NgramSpeculativeDraftDynamicAcceptanceThresholdEngine.js - Speculative Decoding Verifier: NgramSpeculativeDraft -> DynamicAcceptanceThreshold.
 */

class NgramSpeculativeDraftDynamicAcceptanceThresholdEngine {
  constructor(engineConfig = {}) {
    this.strategy = 'NgramSpeculativeDraft';
...
module.exports = { NgramSpeculativeDraftDynamicAcceptanceThresholdEngine };
