/**
 * RDMAClusterCacheAttentionScoreRetentionPolicyController.js - Distributed KV-Cache Accelerator: RDMAClusterCache -> AttentionScoreRetentionPolicy.
 */

class RDMAClusterCacheAttentionScoreRetentionPolicyController {
  constructor(config = {}) {
    this.tier = 'RDMAClusterCache';
...
module.exports = { RDMAClusterCacheAttentionScoreRetentionPolicyController };
