/**
 * SharedMemoryInterprocessContextCompactionPolicyController.js - Distributed KV-Cache Accelerator: SharedMemoryInterprocess -> ContextCompactionPolicy.
 */

class SharedMemoryInterprocessContextCompactionPolicyController {
  constructor(config = {}) {
...
module.exports = { SharedMemoryInterprocessContextCompactionPolicyController };
