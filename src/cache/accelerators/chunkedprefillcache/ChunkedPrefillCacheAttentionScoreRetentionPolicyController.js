/**
 * ChunkedPrefillCacheAttentionScoreRetentionPolicyController.js - Distributed KV-Cache Accelerator: ChunkedPrefillCache -> AttentionScoreRetentionPolicy.
 */

class ChunkedPrefillCacheAttentionScoreRetentionPolicyController {
  constructor(config = {}) {
    this.tier = 'ChunkedPrefillCache';
...
module.exports = { ChunkedPrefillCacheAttentionScoreRetentionPolicyController };
