/**
 * HostRAMPinnedCacheContextCompactionPolicyController.js - Distributed KV-Cache Accelerator: HostRAMPinnedCache -> ContextCompactionPolicy.
 */

class HostRAMPinnedCacheContextCompactionPolicyController {
  constructor(config = {}) {
...
module.exports = { HostRAMPinnedCacheContextCompactionPolicyController };
