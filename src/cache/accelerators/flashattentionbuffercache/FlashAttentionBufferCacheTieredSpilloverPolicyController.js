/**
 * FlashAttentionBufferCacheTieredSpilloverPolicyController.js - Distributed KV-Cache Accelerator: FlashAttentionBufferCache -> TieredSpilloverPolicy.
 */

class FlashAttentionBufferCacheTieredSpilloverPolicyController {
  constructor(config = {}) {
    this.tier = 'FlashAttentionBufferCache';
    this.evictionPolicy = 'TieredSpilloverPolicy';
...
module.exports = { FlashAttentionBufferCacheTieredSpilloverPolicyController };
