/**
 * FlashAttentionBufferCacheZeroCopyTransferPolicyController.js - Distributed KV-Cache Accelerator: FlashAttentionBufferCache -> ZeroCopyTransferPolicy.
 */

class FlashAttentionBufferCacheZeroCopyTransferPolicyController {
  constructor(config = {}) {
    this.tier = 'FlashAttentionBufferCache';
    this.evictionPolicy = 'ZeroCopyTransferPolicy';
...
module.exports = { FlashAttentionBufferCacheZeroCopyTransferPolicyController };
