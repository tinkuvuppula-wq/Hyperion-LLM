/**
 * FlashAttentionBufferCachePrefixTreeSharePolicyController.js - Distributed KV-Cache Accelerator: FlashAttentionBufferCache -> PrefixTreeSharePolicy.
 */

class FlashAttentionBufferCachePrefixTreeSharePolicyController {
  constructor(config = {}) {
    this.tier = 'FlashAttentionBufferCache';
    this.evictionPolicy = 'PrefixTreeSharePolicy';
...
module.exports = { FlashAttentionBufferCachePrefixTreeSharePolicyController };
