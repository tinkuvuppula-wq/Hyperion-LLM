/**
 * FlashAttentionBufferCacheContextCompactionPolicyController.js - Distributed KV-Cache Accelerator: FlashAttentionBufferCache -> ContextCompactionPolicy.
 */

class FlashAttentionBufferCacheContextCompactionPolicyController {
  constructor(config = {}) {
    this.tier = 'FlashAttentionBufferCache';
    this.evictionPolicy = 'ContextCompactionPolicy';
...
module.exports = { FlashAttentionBufferCacheContextCompactionPolicyController };
