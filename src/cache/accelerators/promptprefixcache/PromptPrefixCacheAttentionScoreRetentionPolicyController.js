/**
 * PromptPrefixCacheAttentionScoreRetentionPolicyController.js - Distributed KV-Cache Accelerator: PromptPrefixCache -> AttentionScoreRetentionPolicy.
 */

class PromptPrefixCacheAttentionScoreRetentionPolicyController {
  constructor(config = {}) {
    this.tier = 'PromptPrefixCache';
...
module.exports = { PromptPrefixCacheAttentionScoreRetentionPolicyController };
