/**
 * QuantizedFP8CacheCrossAttentionMemoryReuseController.js - Distributed KV-Cache Accelerator: QuantizedFP8Cache -> CrossAttentionMemoryReuse.
 */

class QuantizedFP8CacheCrossAttentionMemoryReuseController {
  constructor(config = {}) {
...
module.exports = { QuantizedFP8CacheCrossAttentionMemoryReuseController };
