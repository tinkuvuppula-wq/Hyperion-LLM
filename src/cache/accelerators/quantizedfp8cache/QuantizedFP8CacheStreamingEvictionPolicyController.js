/**
 * QuantizedFP8CacheStreamingEvictionPolicyController.js - Distributed KV-Cache Accelerator: QuantizedFP8Cache -> StreamingEvictionPolicy.
 */

class QuantizedFP8CacheStreamingEvictionPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedFP8CacheStreamingEvictionPolicyController };
