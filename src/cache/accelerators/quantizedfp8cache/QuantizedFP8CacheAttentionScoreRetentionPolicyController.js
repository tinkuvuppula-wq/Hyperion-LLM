/**
 * QuantizedFP8CacheAttentionScoreRetentionPolicyController.js - Distributed KV-Cache Accelerator: QuantizedFP8Cache -> AttentionScoreRetentionPolicy.
 */

class QuantizedFP8CacheAttentionScoreRetentionPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedFP8CacheAttentionScoreRetentionPolicyController };
