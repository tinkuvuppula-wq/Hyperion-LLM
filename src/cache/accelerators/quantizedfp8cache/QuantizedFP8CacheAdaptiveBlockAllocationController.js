/**
 * QuantizedFP8CacheAdaptiveBlockAllocationController.js - Distributed KV-Cache Accelerator: QuantizedFP8Cache -> AdaptiveBlockAllocation.
 */

class QuantizedFP8CacheAdaptiveBlockAllocationController {
  constructor(config = {}) {
...
module.exports = { QuantizedFP8CacheAdaptiveBlockAllocationController };
