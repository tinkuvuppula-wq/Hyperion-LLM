/**
 * QuantizedFP8CachePageTableVirtualizationController.js - Distributed KV-Cache Accelerator: QuantizedFP8Cache -> PageTableVirtualization.
 */

class QuantizedFP8CachePageTableVirtualizationController {
  constructor(config = {}) {
...
module.exports = { QuantizedFP8CachePageTableVirtualizationController };
