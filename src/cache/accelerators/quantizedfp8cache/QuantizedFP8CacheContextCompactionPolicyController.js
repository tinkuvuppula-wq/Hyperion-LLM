/**
 * QuantizedFP8CacheContextCompactionPolicyController.js - Distributed KV-Cache Accelerator: QuantizedFP8Cache -> ContextCompactionPolicy.
 */

class QuantizedFP8CacheContextCompactionPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedFP8CacheContextCompactionPolicyController };
