/**
 * QuantizedFP8CacheSpeculativePreloadPolicyController.js - Distributed KV-Cache Accelerator: QuantizedFP8Cache -> SpeculativePreloadPolicy.
 */

class QuantizedFP8CacheSpeculativePreloadPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedFP8CacheSpeculativePreloadPolicyController };
