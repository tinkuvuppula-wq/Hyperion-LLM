/**
 * QuantizedFP8CacheLRUEvictionPolicyController.js - Distributed KV-Cache Accelerator: QuantizedFP8Cache -> LRUEvictionPolicy.
 */

class QuantizedFP8CacheLRUEvictionPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedFP8CacheLRUEvictionPolicyController };
