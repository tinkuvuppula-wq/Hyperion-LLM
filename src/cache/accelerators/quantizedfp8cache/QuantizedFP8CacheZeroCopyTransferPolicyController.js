/**
 * QuantizedFP8CacheZeroCopyTransferPolicyController.js - Distributed KV-Cache Accelerator: QuantizedFP8Cache -> ZeroCopyTransferPolicy.
 */

class QuantizedFP8CacheZeroCopyTransferPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedFP8CacheZeroCopyTransferPolicyController };
