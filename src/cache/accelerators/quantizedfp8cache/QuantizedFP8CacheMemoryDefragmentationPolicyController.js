/**
 * QuantizedFP8CacheMemoryDefragmentationPolicyController.js - Distributed KV-Cache Accelerator: QuantizedFP8Cache -> MemoryDefragmentationPolicy.
 */

class QuantizedFP8CacheMemoryDefragmentationPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedFP8CacheMemoryDefragmentationPolicyController };
