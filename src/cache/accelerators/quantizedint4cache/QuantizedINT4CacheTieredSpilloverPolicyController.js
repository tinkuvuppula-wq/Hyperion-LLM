/**
 * QuantizedINT4CacheTieredSpilloverPolicyController.js - Distributed KV-Cache Accelerator: QuantizedINT4Cache -> TieredSpilloverPolicy.
 */

class QuantizedINT4CacheTieredSpilloverPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedINT4CacheTieredSpilloverPolicyController };
