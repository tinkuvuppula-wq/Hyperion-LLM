/**
 * QuantizedINT4CacheContextCompactionPolicyController.js - Distributed KV-Cache Accelerator: QuantizedINT4Cache -> ContextCompactionPolicy.
 */

class QuantizedINT4CacheContextCompactionPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedINT4CacheContextCompactionPolicyController };
