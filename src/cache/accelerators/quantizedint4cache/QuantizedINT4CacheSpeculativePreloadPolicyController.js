/**
 * QuantizedINT4CacheSpeculativePreloadPolicyController.js - Distributed KV-Cache Accelerator: QuantizedINT4Cache -> SpeculativePreloadPolicy.
 */

class QuantizedINT4CacheSpeculativePreloadPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedINT4CacheSpeculativePreloadPolicyController };
