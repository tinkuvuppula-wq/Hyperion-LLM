/**
 * QuantizedINT4CacheCrossAttentionMemoryReuseController.js - Distributed KV-Cache Accelerator: QuantizedINT4Cache -> CrossAttentionMemoryReuse.
 */

class QuantizedINT4CacheCrossAttentionMemoryReuseController {
  constructor(config = {}) {
...
module.exports = { QuantizedINT4CacheCrossAttentionMemoryReuseController };
