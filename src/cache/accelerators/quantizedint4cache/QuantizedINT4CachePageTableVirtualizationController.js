/**
 * QuantizedINT4CachePageTableVirtualizationController.js - Distributed KV-Cache Accelerator: QuantizedINT4Cache -> PageTableVirtualization.
 */

class QuantizedINT4CachePageTableVirtualizationController {
  constructor(config = {}) {
...
module.exports = { QuantizedINT4CachePageTableVirtualizationController };
