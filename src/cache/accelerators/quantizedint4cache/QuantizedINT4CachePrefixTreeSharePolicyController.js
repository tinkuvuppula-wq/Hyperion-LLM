/**
 * QuantizedINT4CachePrefixTreeSharePolicyController.js - Distributed KV-Cache Accelerator: QuantizedINT4Cache -> PrefixTreeSharePolicy.
 */

class QuantizedINT4CachePrefixTreeSharePolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedINT4CachePrefixTreeSharePolicyController };
