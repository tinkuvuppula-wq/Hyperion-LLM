/**
 * QuantizedINT4CacheZeroCopyTransferPolicyController.js - Distributed KV-Cache Accelerator: QuantizedINT4Cache -> ZeroCopyTransferPolicy.
 */

class QuantizedINT4CacheZeroCopyTransferPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedINT4CacheZeroCopyTransferPolicyController };
