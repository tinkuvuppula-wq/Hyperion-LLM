/**
 * QuantizedINT4CacheLRUEvictionPolicyController.js - Distributed KV-Cache Accelerator: QuantizedINT4Cache -> LRUEvictionPolicy.
 */

class QuantizedINT4CacheLRUEvictionPolicyController {
  constructor(config = {}) {
...
module.exports = { QuantizedINT4CacheLRUEvictionPolicyController };
