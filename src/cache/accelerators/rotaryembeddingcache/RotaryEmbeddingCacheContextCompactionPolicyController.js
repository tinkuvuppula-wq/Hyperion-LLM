/**
 * RotaryEmbeddingCacheContextCompactionPolicyController.js - Distributed KV-Cache Accelerator: RotaryEmbeddingCache -> ContextCompactionPolicy.
 */

class RotaryEmbeddingCacheContextCompactionPolicyController {
  constructor(config = {}) {
...
module.exports = { RotaryEmbeddingCacheContextCompactionPolicyController };
