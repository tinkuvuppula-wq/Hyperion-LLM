/**
 * NeedleInAHaystackLongCtxP99LatencyPercentileProfilerSuite.js - High-Throughput LLM Benchmark Suite: NeedleInAHaystackLongCtx -> P99LatencyPercentileProfiler.
 */

class NeedleInAHaystackLongCtxP99LatencyPercentileProfilerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'NeedleInAHaystackLongCtx';
...
module.exports = { NeedleInAHaystackLongCtxP99LatencyPercentileProfilerSuite };
