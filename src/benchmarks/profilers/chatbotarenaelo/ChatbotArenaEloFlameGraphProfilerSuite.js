/**
 * ChatbotArenaEloFlameGraphProfilerSuite.js - High-Throughput LLM Benchmark Suite: ChatbotArenaElo -> FlameGraphProfiler.
 */

class ChatbotArenaEloFlameGraphProfilerSuite {
...
module.exports = { ChatbotArenaEloFlameGraphProfilerSuite };
