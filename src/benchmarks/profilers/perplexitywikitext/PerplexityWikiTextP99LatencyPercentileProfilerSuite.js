/**
 * PerplexityWikiTextP99LatencyPercentileProfilerSuite.js - High-Throughput LLM Benchmark Suite: PerplexityWikiText -> P99LatencyPercentileProfiler.
 */

class PerplexityWikiTextP99LatencyPercentileProfilerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'PerplexityWikiText';
...
module.exports = { PerplexityWikiTextP99LatencyPercentileProfilerSuite };
