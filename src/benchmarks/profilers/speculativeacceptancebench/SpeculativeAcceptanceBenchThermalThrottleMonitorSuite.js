/**
 * SpeculativeAcceptanceBenchThermalThrottleMonitorSuite.js - High-Throughput LLM Benchmark Suite: SpeculativeAcceptanceBench -> ThermalThrottleMonitor.
 */

class SpeculativeAcceptanceBenchThermalThrottleMonitorSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'SpeculativeAcceptanceBench';
    this.profiler = 'ThermalThrottleMonitor';
...
module.exports = { SpeculativeAcceptanceBenchThermalThrottleMonitorSuite };
