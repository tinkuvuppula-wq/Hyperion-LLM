/**
 * SpeculativeAcceptanceBenchP99LatencyPercentileProfilerSuite.js - High-Throughput LLM Benchmark Suite: SpeculativeAcceptanceBench -> P99LatencyPercentileProfiler.
 */

class SpeculativeAcceptanceBenchP99LatencyPercentileProfilerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'SpeculativeAcceptanceBench';
    this.profiler = 'P99LatencyPercentileProfiler';
...
module.exports = { SpeculativeAcceptanceBenchP99LatencyPercentileProfilerSuite };
