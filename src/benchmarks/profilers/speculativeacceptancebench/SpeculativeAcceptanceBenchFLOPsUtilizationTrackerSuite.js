/**
 * SpeculativeAcceptanceBenchFLOPsUtilizationTrackerSuite.js - High-Throughput LLM Benchmark Suite: SpeculativeAcceptanceBench -> FLOPsUtilizationTracker.
 */

class SpeculativeAcceptanceBenchFLOPsUtilizationTrackerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'SpeculativeAcceptanceBench';
    this.profiler = 'FLOPsUtilizationTracker';
...
module.exports = { SpeculativeAcceptanceBenchFLOPsUtilizationTrackerSuite };
