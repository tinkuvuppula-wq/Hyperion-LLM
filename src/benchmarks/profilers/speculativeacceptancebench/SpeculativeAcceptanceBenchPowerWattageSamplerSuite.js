/**
 * SpeculativeAcceptanceBenchPowerWattageSamplerSuite.js - High-Throughput LLM Benchmark Suite: SpeculativeAcceptanceBench -> PowerWattageSampler.
 */

class SpeculativeAcceptanceBenchPowerWattageSamplerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'SpeculativeAcceptanceBench';
    this.profiler = 'PowerWattageSampler';
...
module.exports = { SpeculativeAcceptanceBenchPowerWattageSamplerSuite };
