/**
 * SpeculativeAcceptanceBenchGarbageCollectionTrackerSuite.js - High-Throughput LLM Benchmark Suite: SpeculativeAcceptanceBench -> GarbageCollectionTracker.
 */

class SpeculativeAcceptanceBenchGarbageCollectionTrackerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'SpeculativeAcceptanceBench';
    this.profiler = 'GarbageCollectionTracker';
...
module.exports = { SpeculativeAcceptanceBenchGarbageCollectionTrackerSuite };
