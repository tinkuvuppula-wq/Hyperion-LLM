/**
 * ContextCompressionF1BenchThreadContentionSamplerSuite.js - High-Throughput LLM Benchmark Suite: ContextCompressionF1Bench -> ThreadContentionSampler.
 */

class ContextCompressionF1BenchThreadContentionSamplerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'ContextCompressionF1Bench';
    this.profiler = 'ThreadContentionSampler';
...
module.exports = { ContextCompressionF1BenchThreadContentionSamplerSuite };
