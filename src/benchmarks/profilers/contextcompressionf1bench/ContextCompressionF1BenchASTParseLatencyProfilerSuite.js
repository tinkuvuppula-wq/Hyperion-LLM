/**
 * ContextCompressionF1BenchASTParseLatencyProfilerSuite.js - High-Throughput LLM Benchmark Suite: ContextCompressionF1Bench -> ASTParseLatencyProfiler.
 */

class ContextCompressionF1BenchASTParseLatencyProfilerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'ContextCompressionF1Bench';
    this.profiler = 'ASTParseLatencyProfiler';
...
module.exports = { ContextCompressionF1BenchASTParseLatencyProfilerSuite };
