/**
 * ContextCompressionF1BenchNetworkThroughputProfilerSuite.js - High-Throughput LLM Benchmark Suite: ContextCompressionF1Bench -> NetworkThroughputProfiler.
 */

class ContextCompressionF1BenchNetworkThroughputProfilerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'ContextCompressionF1Bench';
    this.profiler = 'NetworkThroughputProfiler';
...
module.exports = { ContextCompressionF1BenchNetworkThroughputProfilerSuite };
