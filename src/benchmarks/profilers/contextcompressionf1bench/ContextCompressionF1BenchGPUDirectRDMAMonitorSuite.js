/**
 * ContextCompressionF1BenchGPUDirectRDMAMonitorSuite.js - High-Throughput LLM Benchmark Suite: ContextCompressionF1Bench -> GPUDirectRDMAMonitor.
 */

class ContextCompressionF1BenchGPUDirectRDMAMonitorSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'ContextCompressionF1Bench';
    this.profiler = 'GPUDirectRDMAMonitor';
...
module.exports = { ContextCompressionF1BenchGPUDirectRDMAMonitorSuite };
