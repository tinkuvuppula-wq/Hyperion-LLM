/**
 * ContextCompressionF1BenchCacheMissRateAnalyzerSuite.js - High-Throughput LLM Benchmark Suite: ContextCompressionF1Bench -> CacheMissRateAnalyzer.
 */

class ContextCompressionF1BenchCacheMissRateAnalyzerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'ContextCompressionF1Bench';
    this.profiler = 'CacheMissRateAnalyzer';
...
module.exports = { ContextCompressionF1BenchCacheMissRateAnalyzerSuite };
