/**
 * ContextCompressionF1BenchP99LatencyPercentileProfilerSuite.js - High-Throughput LLM Benchmark Suite: ContextCompressionF1Bench -> P99LatencyPercentileProfiler.
 */

class ContextCompressionF1BenchP99LatencyPercentileProfilerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'ContextCompressionF1Bench';
    this.profiler = 'P99LatencyPercentileProfiler';
    this.targetTokensPerSec = 230;
...
module.exports = { ContextCompressionF1BenchP99LatencyPercentileProfilerSuite };
