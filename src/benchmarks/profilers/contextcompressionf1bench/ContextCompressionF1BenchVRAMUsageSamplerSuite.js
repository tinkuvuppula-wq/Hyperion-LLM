/**
 * ContextCompressionF1BenchVRAMUsageSamplerSuite.js - High-Throughput LLM Benchmark Suite: ContextCompressionF1Bench -> VRAMUsageSampler.
 */

class ContextCompressionF1BenchVRAMUsageSamplerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'ContextCompressionF1Bench';
    this.profiler = 'VRAMUsageSampler';
...
module.exports = { ContextCompressionF1BenchVRAMUsageSamplerSuite };
