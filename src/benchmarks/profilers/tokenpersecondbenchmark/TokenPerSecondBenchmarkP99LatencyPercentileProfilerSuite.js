/**
 * TokenPerSecondBenchmarkP99LatencyPercentileProfilerSuite.js - High-Throughput LLM Benchmark Suite: TokenPerSecondBenchmark -> P99LatencyPercentileProfiler.
 */

class TokenPerSecondBenchmarkP99LatencyPercentileProfilerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'TokenPerSecondBenchmark';
...
module.exports = { TokenPerSecondBenchmarkP99LatencyPercentileProfilerSuite };
