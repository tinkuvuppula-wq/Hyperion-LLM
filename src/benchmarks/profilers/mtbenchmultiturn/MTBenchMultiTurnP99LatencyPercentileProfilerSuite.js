/**
 * MTBenchMultiTurnP99LatencyPercentileProfilerSuite.js - High-Throughput LLM Benchmark Suite: MTBenchMultiTurn -> P99LatencyPercentileProfiler.
 */

class MTBenchMultiTurnP99LatencyPercentileProfilerSuite {
  constructor(suiteConfig = {}) {
    this.workload = 'MTBenchMultiTurn';
...
module.exports = { MTBenchMultiTurnP99LatencyPercentileProfilerSuite };
